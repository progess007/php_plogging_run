<?php
  ...
  require "./php-html/user-html.php";
  $crPage = "user";

  // function change title dynamic \\
  echo ch_title("Dashboard ผู้ใช้งานทั่วไป");

  // Contain User menu bar \\
  require "./php-html/user-nav.php";
...
$rankk = 0; $last_scoree = false; $rowss = 0;
...
?>
          ...
          <div class="d-sm-flex align-items-center justify-content-between my-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard ผู้ใช้งานทั่วไป</h1>
          </div>
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-4">
                      <a class="badge badge-primary p-1 my-2" href="#" data-toggle="modal" data-target="#modalSys">
                        <img src="./image/icon/jogging.png" class="icon-img">
                        <span class="mx-3" style="font-size: 14px;">บันทึกข้อมูลการวิ่ง</span>
                      </a>
                    </div>
                    <div class="col-xl-4 col-md-6 col-sm-4">
                      <a class="nav-link p-0 my-2" href="#" data-toggle="modal" data-target="#modalHistory">
                      <img src="./image/icon/history2.png" class="icon-img">
                        <span class="ml-3">ประวัติการบันทึกข้อมูล</span>
                      </a>
                    </div>
                    <div class="col-xl-4 col-md-6 col-sm-4">
                      <a class="nav-link p-0 my-2" href="#" data-toggle="modal" data-target="#modalRankd">
                      <img src="./image/icon/ranking.png" class="icon-img">
                        <span class="ml-3">ดูอันกับการวิ่ง</span>
                      </a>
                    </div>
                    <div class="col-xl-3 col-md-6 col-sm-4">
                      <a class="nav-link p-0 my-2" href="#" data-toggle="modal" data-target="#modalRankt">
                      <img src="./image/icon/ranking.png" class="icon-img">
                        <span class="ml-3">ดูอันกับการเก็บขยะ</span>
                      </a>
                    </div>
                    <div class="col-xl-4 col-md-6 col-sm-4">
                      <a class="nav-link p-0 my-2" href="#" data-toggle="modal" data-target="#">
                      <img src="./image/icon/diary.png" class="icon-img">
                        <span class="ml-3">กิจกรรมวิ่ง</span>
                      </a>
                    </div>
              ...
              <!-- Icon MEnu -->
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-4">
                      <a class="nav-link p-1 my-2" href="#"  data-toggle="modal" data-target="#modalProfile">
                        <img src="./image/icon/resume.png" class="icon-img">
                        <span class="ml-3">จัดการข้อมูลส่วนตัว</span>
                      </a>
                    </div>

                    <div class="col-xl-3 col-md-6 col-sm-4">
                      <a class="badge badge-light p-1 my-2" href="#" onclick="logout()">
