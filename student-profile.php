  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title">จัดการข้อมูลส่วนตัว</h5>
        ...
        <div class="col-md-4 mb-4">
          ...
          <div class="col-md-5">
            <div class="profile-head">
              ...
              <h6> คณะ : <?php echo $row['faculty'] ?> </h6>
                ...
                <div class="col-md-4 mb-4">
                  ...
                  <div class="form-group text-center" style="position: relative;" >
                    <span class="img-div">
                      ...
                      <div class="text-center img-placeholder" id="proFFF"  onClick="triggerClick()">
                              ...
                              <div class="col-md-6">
                                <p>
                                  <input 
                                   ...
                                   name="email" 
                                   value="<?php echo $row['m_email'] ?>" readonly
                                  >
                                </p>
                              </div>
                            </div>
                                      ...
                                      <option value="" disabled selected><-- กรุณาเลือกคณะ --></option>
                                        <?php
                                          ...
                                          <option 
                                           ...
                                           <?php if ($row['faculty_id'] == $f_id) echo "selected" ?> 
                                          > 
                                          <?= $row["faculty"] ?> 
                                          </option>
                                        <?php } ?>
