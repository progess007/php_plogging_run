...
require_once('./php/connect.php');
  ...
  m.m_password, m.m_name, m.m_lastname, m.m_phone, m.m_img, m.faculty_id, f.faculty,
  m.create_date, m.modify_date, l.m_level FROM m_member m
  JOIN faculty f ON m.faculty_id = f.faculty_id
  JOIN m_level l ON m.m_level = l.m_id
  WHERE member_id=?");
  mysqli_stmt_bind_param($checkID, "i", $_SESSION['std_id']);
