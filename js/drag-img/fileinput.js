...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        disable: function () {
            ...
            $container.find('.fileinput-remove, .file-preview-frame button') //('.fileinput-remove, .fileinput-upload, .file-preview-frame button')
                .attr('disabled', true);
            self._initDragDrop();
            return self.$element;
        },
    ...
    $.fn.fileinput = function (option) {
        ...
        this.each(function () {
            ...
            if (!data) {
                ...
                opt = $.extend(true, {}, $.fn.fileinput.defaults, t, $.fn.fileinputLocales.th, l, options, self.data());
