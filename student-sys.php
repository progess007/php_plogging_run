...
<script>
    ...
    //     //             alert(res);
    //     //               // if(res == "er1") {
    //     //               //   Swal.fire({icon: 'error', title: 'กรุณาอัปโหลดภาพระยะทาง และภาพเซลฟี่เก็บขยะ',timer: 2000,showConfirmButton: false})
    //     //               // } else if(res == "er2") {
    //     //               //   Swal.fire({icon: 'error',title: 'กรุณาอัปโหลดภาพระยะทาง'})
    //     //               // } else if(res == "er3") {
    //     //               //   Swal.fire({icon: 'error',title: 'กรุณาอัปโหลดภาพเซลฟี่เก็บขยะ'})
    //     //               // } else {
    //     //               //   alert("asdasd")
    //     //               // }
    ...
    //           console.log(res);
    //           if (res == "er1") {
    //             Swal.fire({icon: 'error',title: 'กรุณาอัปโหลดภาพระยะทาง และ ภาพเซลฟี่เก็บขยะ'});
    //           }
    //           else if (res == "er2") {
    //             Swal.fire({icon: 'error',title: 'กรุณาอัปโหลดภาพระยะทาง'});
    //           } else if (res == "er3") {
    //             Swal.fire({icon: 'error',title: 'กรุณาอัปโหลดภาพเซลฟี่เก็บขยะ'});
    //           } else if (res == "er4") {
    //             Swal.fire({icon: 'error',title: 'กรุณากรอก ระยะทางการวิ่ง (กิโลเมตร)'});
    //           } else if (res == "er5") {
    //             Swal.fire({icon: 'error',title: 'กรุณาเลือกประเภทขยะ และกรอกข้อมูล'});
    //           } 
    //             else {
    //               if(res == "user") {
    //                 Swal.fire({
    //                   icon: 'success', title: 'บันทึกข้อมูลสำเร็จ', timer: '2000'
    //                 }).then((result) => {$(location).attr('href','./user');})
    //               }
    //               if(res == "student") {
    //                 Swal.fire({
    //                   icon: 'success', title: 'บันทึกข้อมูลสำเร็จ', timer: '2000'
    //                 }).then((result) => {$(location).attr('href','./student');})
    //               }
    //             }
    //         }
    //     });
